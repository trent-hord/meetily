...
// Removed pub(crate) use perf_debug/trace as they cause unused import warnings
// Declared locally they are available via #[macro_use] or module paths if needed.
