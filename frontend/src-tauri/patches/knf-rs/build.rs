...
fn main() {
    ...
    // causing LNK2005 duplicate symbol errors when linking with the rest of
    // the project which uses the dynamic CRT.
    ...
    // On Windows MSVC the C++ runtime is linked automatically; the "c++"
    // library name is GCC/Clang-specific and does not exist on MSVC.
